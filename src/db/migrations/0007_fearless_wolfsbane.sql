...
ALTER TABLE "member_measurements" ALTER COLUMN "weight_kg" SET DATA TYPE numeric(6, 2);--> statement-breakpoint
ALTER TABLE "member_measurements" ALTER COLUMN "body_fat_percent" SET DATA TYPE numeric(5, 2);--> statement-breakpoint
ALTER TABLE "member_measurements" ALTER COLUMN "chest_cm" SET DATA TYPE numeric(6, 2);--> statement-breakpoint
ALTER TABLE "member_measurements" ALTER COLUMN "waist_cm" SET DATA TYPE numeric(6, 2);--> statement-breakpoint
ALTER TABLE "member_measurements" ALTER COLUMN "hip_cm" SET DATA TYPE numeric(6, 2);--> statement-breakpoint
ALTER TABLE "member_measurements" ALTER COLUMN "arm_cm" SET DATA TYPE numeric(6, 2);--> statement-breakpoint
ALTER TABLE "member_measurements" ALTER COLUMN "thigh_cm" SET DATA TYPE numeric(6, 2);--> statement-breakpoint
ALTER TABLE "member_measurements" ALTER COLUMN "bmi" SET DATA TYPE numeric(5, 2);--> statement-breakpoint
...
CREATE UNIQUE INDEX "branches_id_org_unique" ON "branches" USING btree ("id","organization_id");--> statement-breakpoint
